...
@Service
public class BuscadorNidService {
	...
	@Async
	public Future<ResultadoBusquedaEntidad>  getAllNids(String dato, Object[] entidadesFiltro, String datoP1, String datoP2, String datoP3, String datoPagina, EnvironmentType environmentType, String user) throws Exception {

		EnvironmentContextHolder.setEnvironmentType(environmentType);

		Integer cantidadDeRegistros = new Integer("1");
		Integer fin = Integer.parseInt(datoPagina) * 50;
		Integer inicio = fin.intValue() - Integer.parseInt("49");
		...
		ArrayList<NidDTO> nids = new ArrayList<NidDTO>();
		...
		parametrosIn.put("dato", dato.toUpperCase());
		...
		if (datoP3 != null && !datoP3.equals("0")){
			...
			parametrosIn.put("condicionF", "");
		}
		

		ProcedimientoDatoBean procedimientoDato = new ProcedimientoDatoBean("PKG_PUB_BUSQUEDA", "PUB_BUSCA_NID");
		Map<String, String> parametrosDeclarados = xx;

		Map<String, Object> salida = executeService.ejecutarProcedimiento(procedimientoDato, parametrosIn, parametrosDeclarados, "PUB_BUSCA_NID", new Date().getTime());
		...
		ArrayList datoSalida = (ArrayList) salida.get("nid");

		for (Object object : datoSalida) {

			NidDTO nid = new NidDTO((HashMap) object);
		...
		return new AsyncResult<ResultadoBusquedaEntidad>(new ResultadoBusquedaEntidad(nids,cantidadDeRegistros ,inicio,fin,Integer.parseInt(datoPagina),(List) salida.get("P_TF_RAMOS")) );
	...
	@Async
	public Future<ResultadoBusquedaEntidad>  getAllNidsDescargaExcel(String dato, Object[] entidadesFiltro, String datoP1, String datoP2, String datoP3, String datoPagina, EnvironmentType environmentType, String user) throws Exception {

		EnvironmentContextHolder.setEnvironmentType(environmentType);

		Integer cantidadDeRegistros = new Integer("1");
		Integer fin = Integer.parseInt("100") * 50;
		Integer inicio = cantidadDeRegistros;
		...
		Map<String, Object> parametrosIn = new HashMap<String, Object>();
		parametrosIn.put("dato", dato.toLowerCase());
		parametrosIn.put("desde", inicio.toString());
		parametrosIn.put("hasta", fin.toString());
		parametrosIn.put("user", user);
		parametrosIn.put("origen", "go");
