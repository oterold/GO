...
@Service
public class BuscadorProductorService {
	
	@Autowired
	private ExecuteService executeService;
	
	private static final Logger logger = LoggerFactory.getLogger(BuscadorProductorService.class);

	@Async
	public Future<ResultadoBusquedaEntidad>  getAllProductores(String dato,Object[] entidadesFiltro, String datoP1, String datoP2, String datoP3, String datoPagina, EnvironmentType environmentType, String user) throws Exception {

		return getAllProductores(dato, entidadesFiltro, datoP1, datoP2, datoP3, datoPagina, environmentType, user,50);
		
	}
	
	
	@Async
	public Future<ResultadoBusquedaEntidad>  getAllProductores(String dato,Object[] entidadesFiltro, String datoP1, String datoP2, String datoP3, String datoPagina, EnvironmentType environmentType, String user,int tamanioPagina) throws Exception {
		...
		{
			ArrayList<ProductorDTO> productores = new ArrayList<ProductorDTO>();
			Map<String, String> xx = new HashMap<String, String>();

			xx.put("P_TF_PROD", "productores");
			...
			ProcedimientoDatoBean procedimientoDato = new ProcedimientoDatoBean("PKG_PUB_BUSQUEDA", "PUB_BUSCA_PRODUCTORES");
			Map<String, String> parametrosDeclarados = xx;
			
			Map<String, Object> salida = executeService.ejecutarProcedimiento(procedimientoDato, parametrosIn, parametrosDeclarados, "PUB_BUSCA_PRODUCTORES", new Date().getTime());
			...
			ArrayList datoSalida = (ArrayList) salida.get("productores");

			for (Object object : datoSalida) {

				ProductorDTO productor = new ProductorDTO((HashMap) object);
			...
			return new AsyncResult<ResultadoBusquedaEntidad>(new ResultadoBusquedaEntidad(productores,cantidadDeRegistros ,inicio,fin,Integer.parseInt(datoPagina),(List) salida.get("P_TF_RAMOS")) );
